...
namespace QLNS
{
    public partial class FrmMain : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
			...
			thongbao = MessageBox.Show("Bạn Muốn Đăng Xuất Không!", "Thông Báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
		...
		private void cmd_maximax_Click(object sender, EventArgs e)
		{
